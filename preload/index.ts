...
console.log('[Preload] Electron API 已暴露');
    ...
    getRebaseActions: (upstream: string) => ipcRenderer.invoke('git:getRebaseActions', upstream),
    executeRebasePlan: (plan: any) => ipcRenderer.invoke('git:executeRebasePlan', plan),
    listSubmodulesEnhanced: () => ipcRenderer.invoke('git:listSubmodulesEnhanced'),
    syncSubmodule: (path: string) => ipcRenderer.invoke('git:syncSubmodule', path),
    listWorktrees: () => ipcRenderer.invoke('git:listWorktrees'),
    createWorktree: (path: string, ref: string) => ipcRenderer.invoke('git:createWorktree', path, ref),
    ...
    lfsLock: (path: string) => ipcRenderer.invoke('git:lfsLock', path),
    lfsUnlock: (path: string, force?: boolean) => ipcRenderer.invoke('git:lfsUnlock', path, force),
    ...
    executeCustomAction: (id: string, context?: any) => ipcRenderer.invoke('git:executeCustomAction', id, context),
    ...
    bisectStart: (badRef: string, goodRef: string) => ipcRenderer.invoke('git:bisectStart', badRef, goodRef),
    bisectMark: (ref: string, result: string) => ipcRenderer.invoke('git:bisectMark', ref, result),
    ...
    createPatch: (refs: string[], outputPath?: string) => ipcRenderer.invoke('git:createPatch', refs, outputPath),
    applyPatch: (patchPath: string, options?: any) => ipcRenderer.invoke('git:applyPatch', patchPath, options),
    listPatches: (dir?: string) => ipcRenderer.invoke('git:listPatches', dir),
    pushTag: (tagName: string, remote?: string) => ipcRenderer.invoke('git:pushTag', tagName, remote),
